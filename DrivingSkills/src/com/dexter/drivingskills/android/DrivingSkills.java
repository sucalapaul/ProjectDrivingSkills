    ...
    private void setupChat() {
        ...
        mButton1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				job = new ObdCommandJob(new ObdResetCommand());
				mChatService.sendCommand1(job.getCommand());
...
//				mChatService.sendCommand1(job.getCommand());
				...
				job = new ObdCommandJob(new LineFeedOffObdCommand());
				mChatService.sendCommand1(job.getCommand());
				
				job = new ObdCommandJob(new TimeoutObdCommand(62));
				mChatService.sendCommand1(job.getCommand());
			}
		});
        ...
        mButton2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				ObdCommandJob job = new ObdCommandJob(new SelectProtocolObdCommand(ObdProtocols.AUTO));
        ...
        mButton3.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				ObdCommandJob job = new ObdCommandJob(new ThrottlePositionObdCommand());
